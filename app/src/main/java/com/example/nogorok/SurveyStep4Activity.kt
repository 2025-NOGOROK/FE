...
class SurveyStep4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnYes = findViewById<MaterialButton>(R.id.btnLoose)   // "혼자만의 시간" 버튼 (id는 btnLoose 그대로 사용)
        val btnNo = findViewById<MaterialButton>(R.id.btnTight)    // "누군가와 함께하는 시간" 버튼 (id는 btnTight 그대로 사용)
        ...
        // 다음 버튼 클릭 시 다음 설문5 페이지로 이동
        btnNext.setOnClickListener {
            if (selectedOption == 1 || selectedOption == 2) {
                val intent = Intent(this, SurveyStep5Activity::class.java)
